...
import 'package:misskey_dog/core/router/guard/login_callback_guard.dart';
...
final class AppRouter extends $AppRouter {
  ...
  List<AutoRoute> get routes {
    return [
      AutoRoute(page: HomeRoute.page, initial: true, guards: [LoginCallbackGuard(), AuthGuard(_ref)]),
